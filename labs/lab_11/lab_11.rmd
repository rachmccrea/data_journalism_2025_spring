...
library(tigris)
library(tidycensus)
#| output: false #pulled this from prelab
library(rvest) #pulled this from prelab
```
...
elections_url <- "https://elections.maryland.gov/elections/2024/general_Results/gen_results_2024_by_county_11.html"

elections <- elections_url %>% 
  read_html() %>% 
  html_table()
