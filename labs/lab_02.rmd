...
**A2**
July 21-Aug 7 were different from the rest because weeks 30 and 31 (July 21-Aug 3) had a really high number of registrations (breaking 7000 both weeks). Week 24 earlier in the summer had the highest number of registrations, though. I looked it up and all I could find was Hunter Biden being convicted -- not sure why that had such a high number of registrations. 
...
**A4** 
Now, they won't give me the name of the region when I group by and summarize. So I'm gonna assume it's in alphabetical order until I figure out how to fix it. That would mean that Central MD had the most new voters. Also wouldn't label the data when I tried to figure out party registration. I am going to take the L on this. 
