...
It changed the case for a few entries so that all entries of the same restaurant have the same case. Some were changed to uppercase and some to title case. 
...
1. It made the spelling and case for W. Millar & Co (and their catering) all the same.
2. It made all restaurant names uppercase
3. It changed "hilton washington" to "washington hilton" 
...
It's in a different order than the first use of key_collision_merge (but not sure if that's from the last mutate), and everything is uppercase this time. 
...
Did it! Saved the cleaned CSV to my computer.
