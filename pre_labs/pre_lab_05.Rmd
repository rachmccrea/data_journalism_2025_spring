...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** Mostly, but some have "other" and "unaffiliated" columns switched. 
...
It looks like there are 24 rows, and there should be 24 rows. MD has 23 counties plus Baltimore City. 
...
It's joining by county without us having to tell it that. 
...
The county with the highest 18+ Black population as a percentage is Prince George's (about 60.9%). The county with the highest percentage of Democrats is also Prince George's (about 78.3%). 
...
Howard County has the highest 18+ Asian population at about 19.4%, but it's got a lower percentage of Democrats than PG County at about 52.4%. 
...
The data type is a number -- it looks like zip codes. 
